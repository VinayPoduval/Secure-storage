  ...
  if(isset($_POST['submit'])){
    ...
    if(in_array($imagefileActualExt, $allowed)) {
      if($imagefileer === 0){
        ...
        $my_command = escapeshellcmd("python C:/xampp/htdocs/Mescoe-Cloud/decrypt.py C:/xampp/htdocs/Mescoe-Cloud/".$filepath." C:/xampp/htdocs/Mescoe-Cloud/keyimage/".$imagefilename);
